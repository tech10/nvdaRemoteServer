...
```console
$ docker pull ghcr.io/tech10/nvdaremoteserver-docker:v1.0.2
$ docker run --network host ghcr.io/tech10/nvdaremoteserver-docker:v1.0.2
```
